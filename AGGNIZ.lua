    ...
    while task.wait() do
        pcall(function()
            ...
            if DarknessFruit then
                local DarkHaul = DarknessFruit:FindFirstChild("Dark Haul")
                if not LocalPlayer.Backpack:FindFirstChild("Dark Haul") and DarkHaul then
                    DarkHaul:Clone().Parent = LocalPlayer.Backpack
                end
            end
        end)
    end
